...
R_hydrobio = read.csv("hydrobio/Resultats_hydrobio_garonne.CSV", sep=";")
F_hydrobio = read.csv("hydrobio/ListesFauneFlore_hydrobio_garonne.CSV", sep=";")
C_hydrobio = read.csv("hydrobio/ConditionsEnvironnementales_physico_garonne.CSV", sep=";")
...
summary(glm.out1)
# nothing is relvant to explain why some stations give more correct results
